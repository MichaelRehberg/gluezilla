...
/**
 * Copy of {@link CdiConfiguration} because that class is not customizable. Adds
 * {@link ExtendedComponentInjector} to the Application.
 */
public class ExtendedCdiConfiguration {
     ...
     * Constructor
     */
    public ExtendedCdiConfiguration() {
    }
    ...
    public ExtendedCdiConfiguration setPropagation(IConversationPropagation propagation) {
     ...
     * @return
     */
    public ExtendedCdiConfiguration setFallbackBeanManager(BeanManager fallbackBeanManager) {
